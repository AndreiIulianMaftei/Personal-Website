...
<div id = "image-track" data-mouse-down-at = "0" data-prev-percentage = "0" data-clicked = "0" data-percentage = "0">
    <img class="image" src="pic1.jpg" alt="" draggable="false"> 
    <img class="image" src="pic2.jpg" alt="" draggable="false"> 
    <img class="image" src="pic3.jpg" alt="" draggable="false"> 
    <img class="image" src="pic4.png" alt="" draggable="false"> 
    <img class="image" src="pic1.jpg" alt="" draggable="false"> 
    <img class="image" src="pic2.jpg" alt="" draggable="false"> 
    <img class="image" src="pic3.jpg" alt="" draggable="false"> 
</div>
